class Tutorial extends Phaser.Scene {
    ...
    preload() {
        ...
        this.kickerDirectionRulesText = this.add.bitmapText(centerX, centerY / 2, 'pixelKey', 'KICKER:PRESS SPACE TO KICK THE BALL', 20).setTintFill(0x002b5c).setOrigin(0.5)
        this.kickerDirectionRulesText = this.add.bitmapText(centerX, centerY / 2 + 50, 'pixelKey', 'EACH KICK EQUALS 100 POINTS', 20).setTintFill(0x002b5c).setOrigin(0.5)
        
        this.qbDirectionRulesText = this.add.bitmapText(centerX, centerY / 2 + 100, 'pixelKey', 'QB:PRESS UP KEY TO INCREASE VELOCITY', 20).setTintFill(0xe31837).setOrigin(0.5)
        ...
        this.qbDirectionRulesText = this.add.bitmapText(centerX, centerY / 2 + 210, 'pixelKey', 'EACH KICKER MISS EQUALS 100 POINTS', 20).setTintFill(0xe31837).setOrigin(0.5)

        this.winConditionText = this.add.bitmapText(centerX, centerY / 2 + 290, 'pixelKey', 'REACH 1000 POINTS TO WIN', 20).setTintFill(0xfdbb30).setOrigin(0.5);
